...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewAssetModal = __webpack_require__(5);
	
	var _NewAssetModal2 = _interopRequireDefault(_NewAssetModal);
	
	var _AssetProperties = __webpack_require__(6);
	...
	var FileEditor = function (_Component) {
	  ...
	  _createClass(FileEditor, [{
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                _context.next = 5;
	                return _jsreportStudio2.default.api.get('api/asset/' + entity.name, { parseJSON: false });
	    ...
	    value: function render() {
	      ...
	      var downloadUrl = _jsreportStudio2.default.resolveUrl('api/asset/' + entity.name);
	      var mode = 'text';
	      ...
	      return isMetaView ? _react2.default.createElement(
	        ...
	        onUpdate: function onUpdate(v) {
	          return _onUpdate(Object.assign({}, entity, { content: btoa(v) }));
	        }
	      });
	    }
	  }]);
