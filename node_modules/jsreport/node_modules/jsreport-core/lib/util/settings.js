...
Settings.prototype.addOrSet = function (key, value, req) {
  var self = this

  return this.findValue(key, req).then(function (val) {
    if (val == null) {
      return self.add(key, value, req)
    }

    return self.set(key, value, req)
  })
}
